		...
		<main>
			<form method="POST">
				<fieldset>
					...
					<input type="text" id="name" name="name" placeholder="" oninput="MAJ(this)" required><br><br>
					<label>Prénom</label><br><br>
					<input type="text" id="surname" name="surname" placeholder="" oninput="firstMAJ(this)" required><br><br>
					<label>Centre</label><br>
					<input type="text" id="center" placeholder="" oninput="firstMAJ(this)" required><br><br>
					<label>Promotion(s)</label><br>
					<input type="text" id="promotion" placeholder="" oninput="firstMAJ(this)" required><br><br>
					<label>Type de compte</label><br>
					<input name="Centre" id="center2" placeholder="" oninput="firstMAJ(this)" required><br><br>
